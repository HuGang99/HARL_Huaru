...
"""
from harl.envs.battle5v5.env.xsim_env import XSimEnv
from harl.envs.battle5v5.config import IMAGE
from harl.envs.battle5v5.config import TimeRatio
import math
...
class EnvRunner(XSimEnv):
    ...
    def _agent_step(self, agent, cur_time, obs_side):
        ...
        @change date:
        """
        # print(f'传进来的蓝方Agents是：{agent}')
        # print(f'传进来的时间是: {cur_time}')
        # print(f'传进来的蓝方原始信息是: {obs_side}')
